...
public class login_parent extends AppCompatActivity {
    ...
    private static final String TAG = "Login_parent";
        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(login_parent.this, "Authentication failed.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        if (selectedRole != null && selectedRole.equalsIgnoreCase(userRole)) {
                            Intent intent = new Intent(login_parent.this, parent_dashboard.class);
                            startActivity(intent);
                            finish();
                        } else {
                            mAuth.signOut();
                            Toast.makeText(login_parent.this, "Role does not match", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(login_parent.this, "No such document", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(login_parent.this, "Failed to get document", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            Toast.makeText(login_parent.this, "User not authenticated", Toast.LENGTH_SHORT).show();
        }
    }

    private void navigateToRegistration() {
        Intent intent = new Intent(login_parent.this, Registration.class);
        startActivity(intent);
        finish();
    }
}
